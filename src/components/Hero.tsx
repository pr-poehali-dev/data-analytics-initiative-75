  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/af9ebfcc-441a-4723-a986-fd69244095d4/files/ab5f66a3-1c26-4667-8fc1-4f78a5fe727b.jpg"
          alt="Архитектурные чертежи"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Проектная организация"}</p>
          ...
          >
            {"Путь Будущего"}
            <br />
            <span className="text-orange-200">{"Проектируем завтра"}</span>
          </h1>
        </div>
      </div>
