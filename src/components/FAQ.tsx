...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Свяжитесь с нами для первичной консультации. Мы обсудим задачу, определим состав документации, стоимость и сроки. После согласования заключаем договор и приступаем к работе в установленные сроки.",
  },
]
